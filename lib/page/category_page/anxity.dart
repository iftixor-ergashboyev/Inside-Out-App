...
class _AnxietyState extends State<Anxiety> {
  ...
  Future<void> _loadAssets() async {
    ...
    final List<String> assetList = manifestMap.keys
        .where((String key) => key.contains('wallpapers/category/anxiety/'))
        .toList();
      ...
      body: CustomScrollView(
        slivers: [
          SliverAppBar(
            ...
            backgroundColor: Colors.deepOrange,
            title: Text("Anxiety's pictures", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontFamily: 'Inside Out', fontSize: 30)),
            floating: true,
            snap: true,
            expandedHeight: 50.0,
          ),
