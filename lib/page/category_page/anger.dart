...
class _AngerState extends State<Anger> {
  ...
  Future<void> _loadAssets() async {
    ...
    final List<String> assetList = manifestMap.keys
        .where((String key) => key.contains('wallpapers/category/anger/'))
        .toList();
      ...
      body: CustomScrollView(
        slivers: [
          SliverAppBar(
            ...
            backgroundColor: Colors.red,
            title: Text("Anger's pictures", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontFamily: 'Inside Out', fontSize: 30)),
            floating: true,
            snap: true,
            expandedHeight: 50.0,
          ),
